...
CREATE TABLE boms (
    ...
    INDEX idx_boms_code (bom_code),
    INDEX idx_boms_status (status),
    INDEX idx_boms_product_status (product_id, status),
...
CREATE TABLE bom_items (
    ...
    unit_cost DECIMAL(10,2) NOT NULL DEFAULT 0.00,
    subtotal_cost DECIMAL(12,2) NOT NULL DEFAULT 0.00,
...
CREATE TABLE stock_movements (
    ...
    movement_type ENUM('in', 'out', 'adjustment', 'scrap') NOT NULL,
